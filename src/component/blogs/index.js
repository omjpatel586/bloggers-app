...
export const Blogs = () => {
  ...
  useEffect(() => {
    axios
      .get('http://localhost/Patel_Om/project/getBlogs.php')
      .then(function (fetch) {
        setdata([...fetch.data])
  ...
  const handleLike = (props) => {
    play.play()
    axios
      .post(`http://localhost/Patel_Om/project/rewards.php?id=${props}`)
      .then(() => {
  ...
  useEffect(() => {
    axios
      .get('http://localhost/Patel_Om/project/getLikes.php')
      .then(function (fetch) {
        setlike([...fetch.data])
      })
      .catch(function (error) {
