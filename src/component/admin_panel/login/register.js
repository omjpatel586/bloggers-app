...
export const Register = () => {
  ...
  const register = () => {
    ...
    axios
      .post('http://localhost/Patel_Om/project/registerapi.php', fdata)
      .then((data) => {
        console.log(data)
          ...
          <Container>
            ...
            <div className="d-flex p-3" style={{ columnGap: '20px' }}>
              <input
                ...
                onClick={register}
              />
              <a href="/" className="button-login text-decoration-none">
                Back
              </a>
            </div>
          </Container>
