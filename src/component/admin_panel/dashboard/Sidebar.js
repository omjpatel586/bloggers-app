...
export const Sidebar = () => {
    ...
    useEffect(()=>{
        axios.post("https://omcdmiweb.000webhostapp.com/React.js_Project_API./getID.php", fdata)
            .then(function (fetch) {
                setdata(fetch.data)
            })
            ...
            <aside className="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <div className="sidebar position-relative" style={{height: "90vh"}}>
                    ...
                    <div className="user-panel mt-3 pb-3 mb-3 d-flex">
                        <div className="image">
                            <img src={`https://omcdmiweb.000webhostapp.com/React.js_Project_API./${data.picture}`} className="img-circle elevation-2" alt="User Image" />
                        </div>
                        <div className="info">
                            <a href="/" className="d-block text-decoration-none">{data.name}</a>
                        </div>
                    </div>
