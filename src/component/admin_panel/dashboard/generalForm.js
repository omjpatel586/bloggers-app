                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <div className="d-flex align-items-center" style={{ columnGap: "10px" }}>
                                                <div className="d-flex" style={{ columnGap: "10px" }}>
                                                    <input type="radio" name="image" value="online" onChange={() => { setstatus("offline") }}></input>
                                                    <h1 className="fs-6 fw-bolder m-0">Browse From Computer</h1>
                                                </div>
                                                <div className="d-flex" style={{ columnGap: "10px" }}>
                                                    <input type="radio" name="image" value="offline" onChange={() => { setstatus("online") }}></input>
                                                    ...
                                                    (status === "offline") ?
                                                        <div className="input-group">
                                                            <div className="custom-file">
                                                                <input type="file" className="custom-file-input" id="exampleInputFile" name="img" />
                                                        ...
                                                        : (status === "online") ?
                                                            <div className="input-group">
                                                                <div>
                                                                    <input className="form-control" placeholder="Blog Frame URL" type="text" name="img"></input>
                                                                </div>
                                                            </div>
                                                            : ""
                                                }
